...
public class Put01 extends JsonPlaceHolderBaseUrl {
  ...
  */
    ...
    public void put01(){
        ...
        Map<String, Object> expectedData = expectedData();  // metod static oldugu icin proje icinde heryerden goruluyor
        //2. way of setting the data
        Todo expectedTodo = new Todo(21,  "Walk the dog", true);
//        Response response = given().spec(spec).when().get("/{first}/{second}");  -> database deki ilk halini automated olarak gormek icin
